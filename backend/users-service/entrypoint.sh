...
/opt/venv/bin/python auth/manage.py makemigrations --noinput
...
/opt/venv/bin/python auth/manage.py shell -c "
...
/opt/venv/bin/python auth/manage.py collectstatic --noinput
