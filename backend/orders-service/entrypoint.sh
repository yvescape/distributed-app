...
/opt/venv/bin/python orders/manage.py makemigrations --noinput
...
/opt/venv/bin/python orders/manage.py shell -c "
...
/opt/venv/bin/python orders/manage.py collectstatic --noinput
